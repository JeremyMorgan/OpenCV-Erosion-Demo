...
structuring_element_ellipse = cv2.getStructuringElement(
    cv2.MORPH_ELLIPSE, (3, 3))

# Perform erosion on the grayscale image using the ellipse-shaped structuring element
eroded_image_ellipse = cv2.erode(
    image, structuring_element_ellipse, iterations=1)
...
plt.subplot(122), plt.imshow(eroded_image_ellipse,
                             cmap='gray'), plt.title('Eroded Image with Ellipse')
